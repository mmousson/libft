...
The aim was to reimplement some basic gLibc functions in order to manipulate strings, memory, printing on screen, etc...
This static library will then be used for each and everyone of our projects.

Objectives:
- C Basis
- Learn to use and understand the gLibc
- Compiling a Staic Library
...
char				*ft_strmultiply(char *factor1, char *factor2, short rm_front_zeros);
char				*ft_strdivide_two(char *str);
void				*ft_rotate_left(void *array, size_t array_size, size_t n, size_t data_size);
